...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'Authentication', 'description': 'User registration, login, token refresh, 2FA setup, password management, Google OAuth, and account recovery.'},
        {'name': 'Users', 'description': 'User profile management, profile pictures, detailed profiles with KYC, login history, session management, account deactivation, data export, and transaction limits.'},
        {'name': 'Chamas', 'description': 'Chama creation, retrieval, updates, join/leave, member management, health scores, and bulk member invites.'},
        {'name': 'Contributions', 'description': 'Single and bulk contribution recording, listing, verification, and receipt generation for chama groups.'},
        {'name': 'Loans', 'description': 'Loan application, approval, disbursement, repayment tracking, early repayment, and restructuring within chamas.'},
        {'name': 'Meetings', 'description': 'Meeting scheduling, listing, attendance recording, and polls/voting for chama governance.'},
        {'name': 'Investments', 'description': 'SACCO browsing, share holdings, liquidity requests with same-SACCO restriction, buyer opportunities, connections, and offer negotiation.'},
        {'name': 'Settlements', 'description': 'Settlement tracking with full audit trail, event timeline, ledger entries, escrow accounts, and dispute resolution.'},
        {'name': 'Notifications', 'description': 'In-app notification list, unread counts, mark read, device registration, channel preferences, and Swahili localization.'},
        ...
        {'name': 'Reports', 'description': 'Async CSV report generation for transactions, contributions, loans, members, and financial summaries.'},
        {'name': 'Activity', 'description': 'User and chama activity feeds with filtering by type, date range, and related object.'},
        {'name': 'Legal', 'description': 'Terms and conditions, privacy policy, document acceptance tracking, and digital signatures.'},
        {'name': 'Escrow', 'description': 'Escrow account tracking for secure settlement fund holding and release.'},
        {'name': 'Scoring', 'description': 'Credit score calculation with factor breakdown and historical tracking.'},
        {'name': 'Webhooks', 'description': 'Webhook subscription management and delivery tracking for third-party integrations.'},
        {'name': 'Admin', 'description': 'Platform administration endpoints for user management, SACCO management, chama moderation, and audit logs.'},
        {'name': 'Polls', 'description': 'Chama polling and voting system for group decision-making and governance.'},
    ],
}
